				...
				<div id="modal_iconified" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-12">
												...
												<input type="text" id="txtNombre" name="txtNombre" placeholder="EJ. HECTOR MENDOZA / DITEC S DE RL"
												 class="form-control" style="text-transform:uppercase;"
									...
									<div class="form-group">
										<div class="row">
											...
											<div class="col-sm-6">
												...
												<input type="text" id="txtNRC" name="txtNRC" placeholder="EJ. Contacto"
												 class="form-control" style="text-transform:uppercase;"
													onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
										</div>
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6">
												...
												<input type="text" id="txtTelefono" name="txtTelefono" placeholder="EJ. 2243-0768"
												 class="form-control" style="text-transform:uppercase;"
                                        		onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
											...
											<div class="col-sm-6">
												<label>Email</label>
												<input type="email" id="txtEmail" name="txtEmail" placeholder="EJ. sistemas@ditechonduras.com"
												 class="form-control">
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<div class="row">
											...
											<div class="col-sm-6">
												...
												<input type="text" id="txtLimitC" name="txtLimitC" placeholder="EJ. 5,000.00"
                           ...
                           placeholder="EJ. COLONIA FLORENCIA SUR, TEGUCIGALPA"
