									...
									<table id="tbldetalle" class="table table-xxs">
										...
										<tfoot id="totales_foot">
											<tr class="bg-info-800">
												...
												<td align="center" width="26%">ISV %</td>
												<td align="center" width="10%">SUBTOTAL</td>
												<td align="center" width="10%">RET. (-)</td>
												<td align="center" width="10%">TOT. SIN ISV</td>
						    ...
						    <div class="form-group">
									<div class="row">
                                        ...
                                        <select data-placeholder="..." id="cbCompro" name="cbCompro"
                                        	...
                                        	onkeyup="javascript:this.value=this.value.toUpperCase();">
                                        	<?php
                                        		$valorSeleccionado = 3; // 🔁 Cambia este valor por el ID que quieres preseleccionar
                                        		$filas = $objVenta->Listar_Comprobantes();
                                        		if (is_array($filas) || is_object($filas)) {
                                        			foreach ($filas as $row => $column) {
                                        				$selected = ($column["idcomprobante"] == $valorSeleccionado) ? 'selected' : '';
                                        	?>
                                        		<option value="<?php echo $column["idcomprobante"]; ?>" <?php echo $selected; ?>>
                                        			<?php echo strtoupper($column["nombre_comprobante"]); ?>
                                        		</option>
                                        	<?php
                                        			}
                                        		}
										...
										<div id="div-cbMPago" class="col-sm-6">
										 <label>Metodo de Pago</label>
											 <select id="cbMPago" name="cbMPago" data-placeholder="Seleccione un metodo de pago..." class="select-icons">
													 ...
													 <option value="4" data-icon="cash">DEPOSITO</option>
											 </select>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									<div class="row">
											<div class="col-sm-8">
													...
													<div class="input-group">
													<span class="input-group-addon"><i class="icon-credit-card"></i></span>
													<input type="text" id="txtNotas" name="txtNotas" placeholder="Notas adicionales"
													 class="form-control input-sm" style="text-transform:uppercase;"
													 onkeyup="javascript:this.value=this.value.toUpperCase();">
												</div>
											</div>
