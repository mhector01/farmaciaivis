...
<head>
	...
	<meta name="description" content="DitecPos es un sistema de ventas que le permite llevar el control de todo lo relacionado a su negocio.">
	<title>Ditec - Facturación e Inventario</title>
	...
	<link rel="icon" type="image/png" href="https://ditechonduras.com/wp-content/uploads/2020/10/cropped-Logo.png"/>
	<link rel="shortcut icon" href="web/assets/images/logo.png">
	<!-- /global stylesheets -->
...
<body class="sidebar-lg has-detached-right">
	<!-- Main navbar -->
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<a class="navbar-brand" href="./?View=Inicio"><img src="web/assets/images/logoLG.png" alt=""></a>
