...
//**-------- Instanciando Select Cliente
    ...
    $("#cbCliente").val(1).trigger("change");
            ...
            $("#tbldetalle tbody tr").each(function (index)
                {
                    ...
                    $(this).children("td").each(function (index2)
                    {
                      ...
                      total_sumas = (subtotal-total_descuentos) / iva_div;
...
function enviar_data(){
  ...
  var fecha_vence = "";
    ...
    $("#tbldetalle tbody tr").each(function (index)
        ...
        var dataString='&stringdatos='+StringDatos+'&cuantos='+i+'&comprobante='+comprobante+'&notas='+notas;
              ...
              if(data=="Validado"){
                ...
                $('#modal_iconified_cash').modal('toggle');
                  ...
                  swal({
                    ...
                    function(isConfirm){
                      if (isConfirm) {
                          window.open('reportes/pruebaTicket.php?venta=""',
                          'win2',
